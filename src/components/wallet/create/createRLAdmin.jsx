...
import { chialite_to_mojo } from '../../../util/chialite';
...
export const CreateRLAdminWallet = () => {
  ...
  function create() {
    ...
    if (
      chialiteper_input.value === '' ||
      Number(chialiteper_input.value) === 0 ||
      !Number(chialiteper_input.value) ||
      isNaN(Number(chialiteper_input.value))
    ) {
      dispatch(
        openDialog(
          <AlertDialog>
    ...
    const chialiteper = chialite_to_mojo(chialiteper_input.value);
    const chialiteper_value = Number.parseInt(Number(chialiteper));
    ...
    // var fee = chialite_to_mojo(fee_input.value);
