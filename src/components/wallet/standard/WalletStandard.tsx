...
import { AlertDialog, Flex, Card } from '@chialite/core';
...
import { mojo_to_chialite_string, chialite_to_mojo } from '../../../util/chialite';
  ...
  return (
    <Grid item xs={12}>
      <Box display="flex">
        ...
        <Box>
          <Typography variant="subtitle1">
            {mojo_to_chialite_string(props.balance)} {currencyCode}
          </Typography>
        </Box>
      </Box>
    </Grid>
  ...
  return (
    <Card title={<Trans>Balance</Trans>}>
      <BalanceCardSubSection
        ...
        tooltip={
          <Trans>
            This is the total amount of chialite in the blockchain at the current
      ...
      <BalanceCardSubSection
        ...
        tooltip={
          <Trans>
            This is the amount of Chialite that you can currently use to make
            transactions. It does not include pending farming rewards, pending
            incoming transactions, and Chialite that you have just spent but is not
...
function SendCard(props: SendCardProps) {
  ...
  function send() {
    ...
    const amount = chialite_to_mojo(amount_input.value);
    const fee = chialite_to_mojo(fee_input.value);
    ...
    if (address.includes('colour')) {
      dispatch(
        openDialog(
          <AlertDialog>
            <Trans>
              Error: Cannot send chialite to coloured address. Please enter a chialite
              address.
            </Trans>
          </AlertDialog>,
        ),
    ...
    if (address.slice(0, 12) === 'chialite_addr://') {
