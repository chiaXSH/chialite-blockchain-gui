...
import { CardHero, Link } from '@chialite/core';
import { PlotHero as PlotHeroIcon } from '@chialite/icons';
      ...
      <Grid xs={12} md={6} lg={4} item>
        <CardHero>
          ...
          <Typography variant="body1">
            <Trans>
              {'Plots are allocated space on your hard drive used to farm and earn Chialite. '}
              <Link target="_blank" href="https://github.com/Chialite-Network/chialite-blockchain/wiki/Network-Architecture">Learn more</Link>
            </Trans>
          </Typography>
          <Button
