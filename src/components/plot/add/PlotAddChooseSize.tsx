...
import { CardStep, ConfirmDialog, Link, Select, StateColor } from '@chialite/core';
    ...
    >
      <Typography variant="subtitle1">
        <Trans>
          ...
          <Link target="_blank" href="https://github.com/Chialite-Network/chialite-blockchain/wiki/k-sizes">Learn more</Link>
        </Trans>
      </Typography>
